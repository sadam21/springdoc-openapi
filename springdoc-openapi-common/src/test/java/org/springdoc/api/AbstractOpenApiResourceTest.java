...
class AbstractOpenApiResourceTest {
	...
	private static final String PARAMETER_REFERENCE = "#/components/parameters/MyParameter";
	private static final String PARAMETER_WITH_NUMBER_SCHEMA_NAME = "parameterWithNumberSchema";
	private static final String PARAMETER_WITHOUT_SCHEMA_NAME = "parameterWithoutSchema";
